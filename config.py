...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://mongodb+srv://trytime9696:Thebot96@cluster0.qmyorfg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1805959544").split()):
        ADMINS.append(int(x))
except ValueError:
